        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkDateFrom = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorkDateTo = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonelFunctions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AccountRecoveryEmailTokens",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountRecoveryEmailTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountRecoveryEmailTokens_AspNetUsers_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonelId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_PersonelId1",
                        column: x => x.PersonelId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesToStudents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotesToStudents_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NotesToStudents_AspNetUsers_PersonelId",
                        column: x => x.PersonelId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NotesToStudents_AspNetUsers_PersonelId1",
                        column: x => x.PersonelId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EquipmentName = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MembershipName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "MemberPersonelFunctions",
                columns: table => new
                {
                    FunctionsId = table.Column<int>(type: "int", nullable: false),
                    PersonelsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberPersonelFunctions", x => new { x.FunctionsId, x.PersonelsId });
                    table.ForeignKey(
                        name: "FK_MemberPersonelFunctions_AspNetUsers_PersonelsId",
                        column: x => x.PersonelsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberPersonelFunctions_PersonelFunctions_FunctionsId",
                        column: x => x.FunctionsId,
                        principalTable: "PersonelFunctions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountRecoveryEmailTokens_MemberId",
                table: "AccountRecoveryEmailTokens",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PersonelId1",
                table: "Appointments",
                column: "PersonelId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberPersonelFunctions_PersonelsId",
                table: "MemberPersonelFunctions",
                column: "PersonelsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotesToStudents_MemberId",
                table: "NotesToStudents",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_NotesToStudents_PersonelId",
                table: "NotesToStudents",
                column: "PersonelId");

            migrationBuilder.CreateIndex(
                name: "IX_NotesToStudents_PersonelId1",
                table: "NotesToStudents",
                column: "PersonelId1");
